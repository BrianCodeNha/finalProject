...
function QuanLyVeDo(props) {
  ...
  console.log(
    "🚀 ~ file: QuanLyVeDo.js ~ line 21 ~ QuanLyVeDo ~ formErrors",
    formErrors
  );
  ...
  const validate = (values) => {
    ...
    if (!values.giaiBa1 || !values.giaiBa2) {
      ...
      !values.giaiBa1.match(/^-?\d+\.?\d*$/) ||
      !values.giaiBa2.match(/^-?\d+\.?\d*$/)
    ) {
    ...
    if (
      ...
      !values.giaiTu1.match(/^-?\d+\.?\d*$/) ||
      !values.giaiTu2.match(/^-?\d+\.?\d*$/) ||
      !values.giaiTu3.match(/^-?\d+\.?\d*$/) ||
      !values.giaiTu4.match(/^-?\d+\.?\d*$/) ||
      !values.giaiTu5.match(/^-?\d+\.?\d*$/) ||
      !values.giaiTu6.match(/^-?\d+\.?\d*$/) ||
      !values.giaiTu7.match(/^-?\d+\.?\d*$/)
    ) {
    ...
    if (!values.giaiSau1 || !values.giaiSau2 || !values.giaiSau3) {
      ...
      !values.giaiSau1.match(/^-?\d+\.?\d*$/) ||
      !values.giaiSau2.match(/^-?\d+\.?\d*$/) ||
      !values.giaiSau3.match(/^-?\d+\.?\d*$/)
    ) {
  ...
  console.log(
    "🚀 ~ file: QuanLyVeDo.js ~ line 52 ~ QuanLyVeDo ~ newVeDo",
    newVeDo
  );
  ...
  const handleSubmit = (e) => {
    ...
    console.log(
      "🚀 ~ file: QuanLyVeDo.js ~ line 64 ~ handleSubmit ~ isSubmit",
      isSubmit
    );
  ...
  console.log(
    "🚀 ~ file: QuanLyVeDo.js ~ line 18 ~ QuanLyVeDo ~ veDoList",
    veDoList
  );
      ...
      <div className="item">
        ...
        >
          <Link
            exact="true"
            to={`/${
              props.userStatus.role === "admin" ? "vedo/" + staff._id : "#"
            }`}
          >
            <div
              style={{
            ...
            >
              ...
              <strong> Ngày xổ số: </strong>{" "}
              {staff.date.split("-").reverse().join("-")}
              <br />
              ...
              <div className="row" style={{ border: "1px solid" }}>
                ...
                <div className="col-8">
                  {staff.prize.rewardNumbers.giaiNhat}
                </div>
              </div>
              <div className="row" style={{ border: "1px solid" }}>
                <div className="col-4">
              ...
              <div className="row" style={{ border: "1px solid" }}>
                ...
                <div className="col-8">
                  {staff.prize.rewardNumbers.giaiBa.giaiBa1 +
                    " - " +
                    staff.prize.rewardNumbers.giaiBa.giaiBa2}
                </div>
              </div>
              <div className="row" style={{ border: "1px solid" }}>
                <div className="col-4">
                ...
                <div className="col-8">
                  {staff.prize.rewardNumbers.giaiTu.giaiTu1 +
                    " - " +
                    staff.prize.rewardNumbers.giaiTu.giaiTu2 +
                    " - " +
                    staff.prize.rewardNumbers.giaiTu.giaiTu3 +
                    " - " +
                    staff.prize.rewardNumbers.giaiTu.giaiTu4 +
                    " - " +
                    staff.prize.rewardNumbers.giaiTu.giaiTu5 +
                    " - " +
                    staff.prize.rewardNumbers.giaiTu.giaiTu6 +
                    " - " +
                    staff.prize.rewardNumbers.giaiTu.giaiTu7}
                </div>
              </div>
              <div className="row" style={{ border: "1px solid" }}>
                <div className="col-4">
              ...
              <div className="row" style={{ border: "1px solid" }}>
                ...
                <div className="col-8">
                  {staff.prize.rewardNumbers.giaiSau.giaiSau1 +
                    " - " +
                    staff.prize.rewardNumbers.giaiSau.giaiSau2 +
                    " - " +
                    staff.prize.rewardNumbers.giaiSau.giaiSau3}
                </div>
              </div>
              <div className="row" style={{ border: "1px solid" }}>
                <div className="col-4">
        ...
        {props.userStatus.role === "admin" && (
          <div className="row">
            ...
            >
              ...
              />
              <label
                className="btn btn-outline-danger my-2 w-25 px-1"
                htmlFor={staff._id}
              >
                Select
              </label>
              ...
              <Modal show={show} onHide={handleClose}>
                <form onSubmit={handleSubmit}>
                  ...
                  <Modal.Body>
                    <label
                      htmlFor="producer"
                      className="row container form-label"
                    >
                      Đài xổ số:
                      <select
                        name="producer"
